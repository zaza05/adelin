...
$strquery="INSERT INTO  driver SET fullname= '" .$_POST['fullname'] . "', company_name= '". $_POST['company_name'] ."', n_car= '". $_POST['n_car'] ."', contacts= '". $_POST['contacts'] ."', nationality= '". $_POST['nationality'] ."'";
