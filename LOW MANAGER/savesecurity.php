...
$strquery="INSERT INTO security SET fullname= '" .$_POST['fullname'] . "', company_name= '". $_POST['company_name'] ."', n_security= '". $_POST['n_security'] ."', contacts= '". $_POST['contacts'] ."', nationality= '". $_POST['nationality'] ."'";
